...
if __name__ == '__main__':
    ...
    while money_in_dollars > 0:
        ...
        if money_spent == 0:
            messagebox.showinfo("Money", "You have " + money_in_dollars + " left.")
    ...
    if money_in_dollars == 0:
        messagebox.showinfo("Money", "You maximized your money, congratulations!")
    # TODO) If there is a negative amount of money, tell the user they
    #  overspent!
    elif money_in_dollars < 0:
        messagebox.showinfo("Money", "You overspent!")
